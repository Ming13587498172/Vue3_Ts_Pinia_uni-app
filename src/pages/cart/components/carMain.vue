    ...
    <template v-if="profile">
        ...
        <uni-swipe-action>
          ...
          <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
            ...
            <view class="goods">
              ...
              <!-- 商品数量 -->
              <view class="count">
                <vk-data-input-number-box v-model="item.count" :index="item.skuId" :min="1" :max="item.stock"
      ...
      <view class="toolbar" :style="{ paddingBottom: safeAreaInsets!.bottom + 'px' }">
        ...
        <view class="button-grounp">
          <view class="button payment-button" :class="{ disabled: selectedCartListCount === 0 }" @tap="gotoPayment"> 去结算{{
