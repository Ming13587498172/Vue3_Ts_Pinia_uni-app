...
import { SkuPopupEvent, SkuPopupInstanceType, SkuPopupLocaldata } from '@/components/vk-data-goods-sku-popup/vk-data-goods-sku-popup'
...
const onTapImage = (url: string) => {
  uni.previewImage({
    current: url, //  要预览的图片路径
    urls: goods.value!.mainPictures // 必传属性    图片集合 -> 图片链接列表
  })
}
    ...
    <view class="detail panel">
      ...
      <view class="content">
        <view class="properties">
          ...
          <!-- 图片详情 -->
          <image v-for="img in goods?.details.pictures" :key="img" mode="widthFix" :src="img"></image>
        </view>
      </view>
    </view>
