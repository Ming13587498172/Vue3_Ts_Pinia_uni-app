...
import { ref } from 'vue'
import { getMemberOrderByIdAPI, getMemberOrderConsignmentByIdAPI, getMemberOrderLogisticsByIdAPI, putMemberOrderReceiptByIdAPI, deleteMemberOrderAPI } from '@/services/order'
...
<template>
  ...
  <scroll-view scroll-y class="viewport" id="scroller" @scrolltolower="onScrolltolower">
    <template v-if="order">
      ...
      <view class="shipment">
        <!-- 订单物流信息 -->
        <view v-for="item in logistcList" :key="item.id" class="item">
          <view class="message">
            {{ item.text }}
          </view>
